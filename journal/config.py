...
ALPHA = [0.75, 0.8, 0.85, 0.9, 0.95,1.0,1.05,1.1,1.15,1.2,1.25]
#ALPHA = [0.6, 0.8, 1.0, 1.2]

# Total size of network cache as a fraction of content population
NETWORK_CACHE = [0.002, 0.006, 0.01, 0.014, 0.018, 0.022, 0.026, 0.03, 0.04, 0.05]
...
default['strategy']['name'] = STRATEGIES
